        ...
        tinyPlayer: {
                ...
                return $("<div>")
                    ...
                    .append(
                        $("<div>")
                            ...
                            .append(
                                $(
                                    '<div class="player-button ms-2 fas fa-play">'
                                )
                            )
                            .append(
                                $(
                                    '<div class="player-button ms-2 fas fa-pause">'
                                ).hide()
                            )
                            .append(
                                $(
                                    '<div class="player-button ms-4 me-4 fas fa-stop">'
                                )
                            )
                            .append(
                            ...
                            .append(
                                $(
                                    '<div class="player-button fas fa-volume-up">'
                                )
                            )
                    )
                    .append(
            ...
            _createHowlForPlayer: function (player, song) {
                ...
                return new Howl({
                    ...
                    onload: function () {
                        ...
                        song_elem
                            .find(".song-timer")
                            .html(ns._formatTime(self.duration()));
                    },
                    onend: function () {
                        var self = this;
                        song_elem
            ...
            _bindPlayerControls: function (player, elem, idx) {
                ...
                elem.find(".song-volume-bar#fgg").click(function (event) {
                    ...
                    x =
                        x -
                        elem.find(".song-volume-bar#bg").offset().left -
                        7.5;
                ...
                var _seekPercentage = function (event, elem, object_class) {
                    ...
                    var width = parseFloat(
                        elem.find(".song-seek").innerWidth()
                    );
                ...
                elem.find(".song-progress").mouseup(function () {
                    player._seeking = false;
                    player.seek(
                        _seekPercentage(idx, event, elem, ".song-progress")
                    );
                });
            },
